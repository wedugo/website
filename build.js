...
async function buildWedugoQuizSite() {
    try {
        ...
        for (const [cat, quizzes] of Object.entries(categoriesMap)) {
            ...
            // --- ADDITION: GENERATE MULTI-QUESTION PRACTICE SETS (10 per set) ---
        ...
        console.log("Success! Preserved original architecture and ADDED multi-question Practice Sets to Category Pages.");
    } catch (error) {
